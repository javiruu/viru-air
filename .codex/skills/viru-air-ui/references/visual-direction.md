...
- Usar paneles de borde fino, radios consistentes y sombras suaves con calidez.
- No aplanar la UI hacia dashboards serios o plantillas SaaS genericas.
- Reforzar estados vacios con personalidad (microcopy vivo + detalle visual sutil), sin ruido visual.
- Respetar paleta y tokens canonicos; no introducir colores fuera de base.
