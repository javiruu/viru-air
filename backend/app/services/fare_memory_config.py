...
FARE_MEMORY_WATCHLIST_BACKFILL_ENABLED = FARE_MEMORY_ENABLED and _env_bool(
...
FARE_MEMORY_RETENTION_ENABLED = FARE_MEMORY_ENABLED and _env_bool("FARE_MEMORY_RETENTION_ENABLED", False)
FARE_MEMORY_RETENTION_BATCH_SIZE = _env_int("FARE_MEMORY_RETENTION_BATCH_SIZE", 500, minimum=1)
FARE_MEMORY_REVALIDATION_WORKER_ENABLED = FARE_MEMORY_ENABLED and _env_bool(
    "FARE_MEMORY_REVALIDATION_WORKER_ENABLED",
    False,
)
FARE_MEMORY_REVALIDATION_WORKER_INTERVAL_SECONDS = _env_int(
    "FARE_MEMORY_REVALIDATION_WORKER_INTERVAL_SECONDS",
    60,
    minimum=1,
)
FARE_MEMORY_REVALIDATION_WORKER_BATCH_SIZE = _env_int("FARE_MEMORY_REVALIDATION_WORKER_BATCH_SIZE", 20, minimum=1)
