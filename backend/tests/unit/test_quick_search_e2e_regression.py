...
class QuickSearchE2ERegressionTests(unittest.TestCase):
    ...
    def test_save_result_seeds_watchlist_snapshot_from_observed_price(self):
        ...
        try:
            ...
            self.assertEqual(len(snapshots_before_worker), 4)
            ...
            self.assertFalse(snapshots_before_worker[1].is_stale)
            self.assertEqual(float(snapshots_before_worker[2].raw_price), 49.0)
            self.assertFalse(snapshots_before_worker[2].is_stale)
            self.assertEqual(float(snapshots_before_worker[3].raw_price), 47.0)
            self.assertTrue(snapshots_before_worker[3].is_stale)
            ...
            self.assertEqual(len(snapshots_after_worker), 5)
            refreshed_snapshots = [
                snapshot
