...
const tabs = [
  {
    ...
    desc: "Tu base para Búsqueda rápida.",
  },
  {
    id: "puerta-a-puerta",
    label: "Puerta a puerta",
    href: "/preferencias/puerta-a-puerta",
    desc: "Origen habitual.",
  },
  {
    id: "apariencia",
    label: "Apariencia",
  ...
  },
  {
    ...
    href: "/preferencias/region",
    desc: "Idioma, moneda y formatos.",
  },
] as const;
...
export default async function PreferenciasHubPage({ searchParams }: PageProps) {
  ...
  const selected =
    typeof resolvedSearchParams?.tab === "string" ? resolvedSearchParams.tab : "busqueda";
