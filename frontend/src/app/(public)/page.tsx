          ...
          <div className="landing-hero-v2 landing-conv-hero-grid">
            ...
            <div className="landing-hero-v2-copy landing-conv-copy">
              ...
              <div className="landing-cta-row">
                <Link href={authEntryHref} className="btn-primary btn-layered">
                  {t("public.landing.ctaEnter")}
                </Link>
                <Link href={registerHref} className="btn-secondary">
                  {t("public.landing.ctaCreate")}
                </Link>
                <Link href="/policies" className="linkInline landing-hero-link">
                  {t("public.landing.policies")}
                </Link>
              </div>
            ...
            <aside className="landing-signal-panel landing-conv-demo">
                ...
                <article className="landing-demo-card landing-demo-card--calendar">
                  ...
                  <div className="demo-calendar-grid demo-calendar-grid-v3">
                    {calendarDays.map((day, index) => (
                      <span key={`hero-demo-day-${index}`} className="demo-day">
                        {day}
                      </span>
                    ))}
                    {Array.from({ length: 14 }).map((_, index) => (
                      <span
                        key={`hero-demo-date-${index}`}
                        className={`demo-date demo-date-${(index % 3) + 1}`}
                      >
                        {index + 10}
                      </span>
                    ))}
              ...
              <div className="landing-signal-foot landing-signal-foot--elevated">
                ...
                <span className="signal-chip signal-chip-muted">
                  {t("public.landing.signalUpdated")}
                </span>
                <span className="signal-chip signal-chip-success">
                  {t("public.landing.demoDecisionReady")}
                </span>
              </div>
            </aside>
          </div>
          ...
          <article className="landing-capability-main landing-decision-story">
            <div className="landing-cap-main-grid">
              ...
              <div className="pulse-row">
                ...
                <div className="pulse-chip pulse-chip-muted">
                  {t("public.landing.pulseAlertState")}
                </div>
              </div>
              <div className="pulse-row">
                <div>
        ...
        <div className="landing-inner landing-inner-wide">
          <div className="landing-close-cta landing-close-cta-v2">
            ...
            <div className="landing-close-actions">
              ...
              <Link href="/policies" className="linkInline">
                {t("public.landing.policies")}
              </Link>
            </div>
          </div>
