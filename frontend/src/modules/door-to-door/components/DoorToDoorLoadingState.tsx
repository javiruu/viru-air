...
export function DoorToDoorLoadingState() {
  ...
  return (
    <section
      className="panel d2d-loading-state d2d-state-enter"
      role="status"
      aria-live="polite"
      aria-label={t("doorToDoor.states.loadingTitle")}
    >
      ...
      <BoneyardLoad
        name="door-to-door-results-load"
        className="d2d-loading-bones"
        ariaLabel={t("doorToDoor.states.loadingTitle")}
      >
        {[1, 2, 3].map((i) => (
