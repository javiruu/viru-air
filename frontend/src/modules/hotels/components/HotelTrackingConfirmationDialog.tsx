    ...
    >
      ...
      >
        ...
        <div className="section-gap-sm">
          <p>
            <strong>{t("hotels.trackingConfirmation.hotel")}:</strong> {hotel.canonical_name},{" "}
            {hotel.city}
          </p>
          <p>
            <strong>{t("hotels.trackingConfirmation.stay")}:</strong>{" "}
            {formatStayDate(rate.check_in, localeTag)} – {formatStayDate(rate.check_out, localeTag)}{" "}
            ({t("hotels.trackingConfirmation.nights", { count: nights })},{" "}
            {t("hotels.trackingConfirmation.guests", { count: rate.guests })})
          </p>
          <p>
            <strong>{t("hotels.trackingConfirmation.room")}:</strong>{" "}
            {rate.room_label ?? fallbackDetail}
          </p>
          <p>
            <strong>{t("hotels.trackingConfirmation.mealPlan")}:</strong>{" "}
            {rate.meal_plan ?? fallbackDetail}
          </p>
          <p>
            <strong>{t("hotels.trackingConfirmation.cancellation")}:</strong>{" "}
            {rate.cancellation_policy ?? fallbackDetail}
          </p>
          <p>
            <strong>{t("hotels.trackingConfirmation.provider")}:</strong> {rate.provider}
          </p>
          <p>
          ...
          <p>
            <strong>{t("hotels.trackingConfirmation.observedAt")}:</strong>{" "}
            {formatObservedAt(rate.collected_at, localeTag)}
          </p>
        </div>
