export const watchlistEs = {
  ...
  smartList: {
    ...
    routeToolsAria: "Filtros y orden de rutas vigiladas",
    origin: "Origen",
    destination: "Destino",
    allOrigins: "Todos",
    ...
    routeFiltersEmpty: "No hay rutas que coincidan con esta selección.",
    routeFiltersEmptyCta: "Ver todas las rutas",
  ...
  detail: {
    ...
    fareComparison: {
      fromLabel: "Desde",
      customizeLabel: "Extras del viaje",
      noExtras: "Sin extras",
      increaseLabel: "Hasta +{value}",
      noVerifiedAmount: "Sin importe verificable",
      unavailableKinds: "{extras} no se suma(n): sin tarifa pública verificable",
      extraNames: {
        cabin_bag_10kg: "Equipaje de cabina",
        checked_bag_20kg: "Maleta facturada",
...
export const watchlistEn = {
  ...
  smartList: {
    ...
    routeToolsAria: "Monitored route filters and sorting",
    origin: "Origin",
    ...
    routeFiltersEmpty: "No routes match this selection.",
    routeFiltersEmptyCta: "Show all routes",
  ...
  detail: {
    ...
    fareComparison: {
      fromLabel: "From",
      customizeLabel: "Trip extras",
      noExtras: "No extras",
      increaseLabel: "Up to +{value}",
      noVerifiedAmount: "No verified amount",
      unavailableKinds: "{extras} excluded: no verifiable public fare",
      extraNames: {
        cabin_bag_10kg: "Cabin bag",
        checked_bag_20kg: "Checked bag",
