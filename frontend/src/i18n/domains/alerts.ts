export const alertsEs = {
  ...
  form: {
    ...
    freshnessWarm: "La señal existe, pero ya no es reciente. Revalida antes de confiar en el umbral.",
    freshnessStale: "Precio histórico. Guardamos la regla, pero conviene revalidar antes de decidir.",
    freshnessNoData: "Todavía no hay una señal válida para esta ruta. Revalida antes de confiar en la alerta.",
