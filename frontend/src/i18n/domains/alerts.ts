export const alertsEs = {
  ...
  form: {
    ...
    freshnessLabel: "Estado del precio actual",
    ...
    freshnessStale: "Solo contamos con un precio antiguo. Puedes guardar la regla, pero conviene actualizar antes de decidir.",
