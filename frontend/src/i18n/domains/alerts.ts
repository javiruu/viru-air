export const alertsEs = {
  ...
  cadence: {
    ...
    noRoute: "Selecciona una ruta",
    ruleState: "{active} activas · {paused} pausadas",
    rhythm: "Ritmo mínimo",
    every: "Cada {minutes} min",
    noActiveRules: "Sin reglas activas",
    rhythmHint: "Cooldown más corto entre las reglas activas",
    lastConnection: "Última conexión",
    noEvaluation: "Aún sin evaluación",
  ...
  list: {
    ...
    emptyStepSimulate: "Prueba de señal",
    emptyCta: "Configurar regla",
  },
  row: {
...
export const alertsEn = {
  ...
  cadence: {
    kicker: "Signal connection",
    title: "How your rules reach the inbox",
    subtitle: "A simple view of the selected route's scope, cadence, and latest connection.",
    openPending: "Open pending",
    saveQuietHours: "Save schedule",
    scope: "Connected route",
    noRoute: "Select a route",
    ruleState: "{active} active · {paused} paused",
    rhythm: "Minimum cadence",
    every: "Every {minutes} min",
    noActiveRules: "No active rules",
    rhythmHint: "Shortest cooldown among active rules",
    lastConnection: "Latest connection",
    noEvaluation: "Not evaluated yet",
    connectionHint: "Updates when a rule creates history",
  },
  flow: {
  ...
  list: {
    ...
    emptyStepSimulate: "Signal test",
    emptyCta: "Configure rule",
  },
  row: {
    cooldown: "Cooldown: {value} min",
