export const doorToDoorEs = {
  ...
  form: {
    ...
    timezonePill: "Aquí estás: {zone}",
    timezoneAria: "Zona horaria local",
    knownRouteTag: "Ruta que ya conoces",
    knownRouteTooltip: "Has calculado esta ruta {count} veces.",
  },
  autocomplete: {
  ...
  sections: {
    ...
    corridors: {
      title: "Dónde tenemos datos en tiempo real",
      body: "Estas son las rutas donde Viru puede consultar horarios reales desde feeds abiertos. Si tu viaje cae dentro de una de ellas, verás opciones confirmadas; si no, te mostraremos enlaces a Google Maps, BlaBlaCar o GoOpti.",
      bothLegs: "Ambos tramos",
      status: {
        verified: "Verificado",
        verified_limited: "Verificado (ventana corta)",
        planned_blocked: "En preparación",
      },
    },
  ...
  option: {
    ...
    score: "Score {score}",
    scheduleUnconfirmed: "Horario no confirmado",
    durationUnconfirmed: "Duración no confirmada",
    deltaUnavailable: "—",
    ...
    viewRouteInMaps: "Ver ruta en Maps",
    fromPriceEur: "Desde {price} EUR",
    ...
    estimatePreambleTitle: "Esto no son rutas reales",
    corridors: {
      title: "Dónde tenemos datos en tiempo real",
      body: "Estas son las rutas donde Viru puede consultar horarios reales desde feeds abiertos. Si tu viaje cae dentro de una de ellas, verás opciones confirmadas; si no, te mostraremos enlaces a Google Maps, BlaBlaCar o GoOpti.",
      bothLegs: "Ambos tramos",
    ...
    completenessFull: "Itinerario completo",
    completenessPartial: "Parcial accionable",
    completenessExploratory: "Exploratorio",
...
export const doorToDoorEn = {
  ...
  form: {
    ...
    timezonePill: "You are here: {zone}",
    timezoneAria: "Local timezone",
    knownRouteTag: "A route you know",
    knownRouteTooltip: "You have planned this route {count} times.",
  },
  autocomplete: {
  ...
  sections: {
    ...
    corridors: {
      title: "Where we have real-time data",
      body: "These are the routes where Viru can pull real schedules from open feeds. If your trip falls inside one of them, you'll see confirmed options; otherwise we'll fall back to Google Maps, BlaBlaCar, or GoOpti deeplinks.",
      bothLegs: "Both legs",
      status: {
        verified: "Verified",
        verified_limited: "Verified (short window)",
        planned_blocked: "In preparation",
      },
    },
  ...
  mapHub: {
    ...
    whyMissing: {
      ...
      immersive_preview_pending: "Immersive preview pending wiring.",
  ...
  option: {
    ...
    score: "Score {score}",
    scheduleUnconfirmed: "Schedule not confirmed",
    durationUnconfirmed: "Duration not confirmed",
    deltaUnavailable: "—",
    ...
    viewRouteInMaps: "View route in Maps",
    fromPriceEur: "From {price} EUR",
    ...
    estimatePreambleTitle: "These are not real routes",
    corridors: {
      title: "Where we have real-time data",
      body: "These are the routes where Viru can pull real schedules from open feeds. If your trip falls inside one of them, you'll see confirmed options; otherwise we'll fall back to Google Maps, BlaBlaCar, or GoOpti deeplinks.",
      bothLegs: "Both legs",
    ...
    completenessFull: "Full itinerary",
    completenessPartial: "Partial actionable",
    completenessExploratory: "Exploratory",
    ...
    segmentActions: "Actions by segment",
