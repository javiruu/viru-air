export const doorToDoorEs = {
  ...
  mapHub: {
    ...
    sections: {
      ...
      alternativesBody: "Comparacion rapida por tiempo, coste, riesgo y huella.",
    ...
    cards: {
      ...
      alternatives: { title: "Alternativas inteligentes", description: "Trade-offs entre opcion rapida, barata y de menor riesgo." },
  ...
  option: {
    ...
    reasons: {
      ...
      risk: "Mantiene riesgo operativo más bajo.",
...
export const doorToDoorEn = {
  ...
  mapHub: {
    ...
    sections: {
      ...
      alternativesBody: "Quick trade-offs by time, cost, risk, and footprint.",
    ...
    cards: {
      ...
      alternatives: { title: "Smart alternatives", description: "Trade-offs across fastest, cheapest, and lower-risk options." },
  ...
  option: {
    ...
    reasons: {
      ...
      risk: "Maintains lower operational risk.",
