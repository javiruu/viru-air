export const doorToDoorEs = {
  ...
  mapHub: {
    ...
    whyMissing: {
      ...
      fares_and_booking_pending: "Horarios públicos sin tarifas ni reserva directa.",
      ...
      busy_times_and_parking_pending: "Información de ocupación y parking pendiente.",
...
export const doorToDoorEn = {
  ...
  mapHub: {
    ...
    whyMissing: {
      ...
      fares_and_booking_pending: "Public schedules without fares or direct booking.",
      ...
      busy_times_and_parking_pending: "Occupancy and parking info pending.",
