export const publicEs = {
  ...
  auth: {
    ...
    registerEmailInUse: "Ese correo ya está registrado. Inicia sesión o usa otro correo.",
    registerWeakPassword: "La contraseña es demasiado débil. Usa al menos 8 caracteres combinando letras y números.",
...
export const publicEn = {
  ...
  auth: {
    ...
    registerEmailInUse: "That email is already registered. Sign in or use another email.",
    registerWeakPassword: "That password is too weak. Use at least 8 characters mixing letters and numbers.",
