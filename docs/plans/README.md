...
Esta carpeta separa los planes de trabajo del resto de la documentación viva.
...
- [Plan progresivo de 20 fases — Quick Search + Ajustes activos](active/2026-07-01-plan-20-fases-quick-search-ajustes.md)
- [Quick Search ajustes — Fase 1 inventario](active/2026-07-01-quick-search-ajustes-fase-01-inventario.md)

## Planes completados archivados

- [Live flight tracking a partir de Watchlist](../archive/plans/2026-07-21-live-flight-tracking-watchlist.md)
