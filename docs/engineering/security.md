...
Las reglas de seguridad documental y operativa aparecen repartidas entre `AGENTS.md`, `README.md`, la referencia de Codex y algunos checklists/runbooks.
...
- [Done checklist](../reference/done-checklist.md)
