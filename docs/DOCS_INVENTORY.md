...
| users_prueba.txt | sensitive | sensible | eliminado | (eliminado 2026-09-23 con aprobacion del usuario) | Contenia credenciales de prueba locales; reemplazado por las semillas RUN_SEED_USERS del backend | docs/runbooks/runbook-supabase-native.md |
